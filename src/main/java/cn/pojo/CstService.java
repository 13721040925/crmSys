...
public class CstService implements Serializable {
	private static final long serialVersionUID = -1815244841819782289L;
	...
	public String toString() {
		return "CstService [svrId=" + svrId + ", svrCustNo=" + svrCustNo + ", svrType=" + svrType + ", svrTitle="
				+ svrTitle + ", svrCustName=" + svrCustName + ", svrStatus=" + svrStatus + ", svrRequest=" + svrRequest
